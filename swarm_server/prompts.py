...
COMMON_SOUL_TEMPLATE = (
    ...
    "clear reason instead: it gives the human a link that opens the live team "
    "browser so THEY complete that one step, then hands control straight back to "
    ...
    "page is loaded'). The human gets a link that opens the live browser, they "
